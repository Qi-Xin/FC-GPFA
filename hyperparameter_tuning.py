...
param_dist = {
    ...
    'lr_transformer': hp.choice('lr_transformer', [1e-4, 1e-3, 1e-2]),
    'lr_sti': hp.choice('lr_sti', [1e-3, 1e-2, 1e-1]),
    'lr_cp': hp.choice('lr_cp', [1e-3, 1e-2, 1e-1]),
    'dropout': hp.choice('dropout', [0, 0.1, 0.2, 0.3, 0.5]),
    'weight_decay': hp.choice('decay', [0.0, 0.1, 0.2, 0.5]),
